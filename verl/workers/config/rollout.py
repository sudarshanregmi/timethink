...
class RolloutConfig(BaseConfig):
    ...
    # Stop strings for generation. Generation stops when any of these strings is produced.
    # Only applied during training rollout, NOT during validation.
    stop: Optional[list] = None

    # Whether to include the stop string in the output. Default True so that
    # downstream parsers (e.g. regex matching </think>) still see the stop string.
