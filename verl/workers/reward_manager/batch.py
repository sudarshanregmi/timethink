...
class BatchRewardManager(AbstractRewardManager):
    ...
    def verify(self, data):
        ...
        ground_truths = [_parse_json(item.non_tensor_batch["reward_model"]).get("ground_truth", None) for item in data]
        ...
        extras = [_parse_json(e) for e in extras]
    ...
    def __call__(self, data: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        ...
        for i in range(len(data)):
            ...
            if already_printed.get(data_source, 0) < self.num_examine:
                ...
                ground_truth = _parse_json(data[i].non_tensor_batch["reward_model"]).get("ground_truth", None)
